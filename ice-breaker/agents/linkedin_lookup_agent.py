...
def lookup(name: str) -> str:
    ...
    Your answer should contain only a URL. URLs should be in the format of https://www.linkedin.com/<profile-id>"""
...
if __name__ == "__main__":
    linkedin_url = lookup(name="Jose Gabriel Martinez Martin")
    print(linkedin_url)
